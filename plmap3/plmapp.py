...
def queue_exec(input_queue, output_queue, p_id, progress_details, default_output, individual_timeout=300.0):
    ...
    if p_id != -1: # Not a progress bar process
        ...
        while True: 
            ...
            except FunctionTimeoutException as details:
...
def plmapp(func, args=[], kwargs=[], processes=10, progress_bar=False, default_output=None, individual_timeout=300):
    """ 
    """
    ...
    output_errors = [ None for _ in range(big_len)]
    output_values = [ None for _ in range(big_len)]
